...
export default {
  ...
  methods: {
    ...
    async openWebsiteDialog(mainText) {
      ...
      // console.log('this.$refs.gasCtx', this.$refs.gasCtx)
      // this.$refs.gasCtx.setEstimate(this.estimateWebsiteCommit);
    ...
    async fetchWebsiteSignedRawData() {
      try {
        ...
        logger.debug('pull web respState>>>>', respState, typeof respState);
    ...
    async fetchMobileSignedRawData() {
      try {
        ...
        logger.debug('pull Mob respState>>>>', respState, typeof respState);
